"""Benefits Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Employee benefits administration agent that answers benefits questions, guides enrollment decisions, compares plan options, processes life event changes, and manages open enrollment communications.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
