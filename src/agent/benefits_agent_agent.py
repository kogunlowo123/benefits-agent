"""Benefits Agent - Main Agent Implementation."""
...
class BenefitsAgentAgent:
    ...
    def __init__(self):
        ...
        self.benefits_guidance_enabled = True
        self.enrollment_support_enabled = True
        self.plan_comparison_enabled = True
        self.life_event_processing_enabled = True
        self.open_enrollment_enabled = True
        self._tool_dispatch = {
            "answer_benefits_question": self.tools.answer_benefits_question,
            "compare_plans": self.tools.compare_plans,
            "process_life_event": self.tools.process_life_event,
            "estimate_costs": self.tools.estimate_costs,
            "send_enrollment_reminder": self.tools.send_enrollment_reminder,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['benefits_guidance', 'enrollment_support', 'plan_comparison', 'life_event_processing', 'open_enrollment'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "answer_benefits_question": ['answer', 'benefits', 'question'],
            "compare_plans": ['compare', 'plans'],
            "process_life_event": ['process', 'life', 'event'],
